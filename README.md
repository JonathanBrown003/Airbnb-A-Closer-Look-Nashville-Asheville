...
The zip codes for the Nashville dataset was obtained from the following [website.](https://simplemaps.com/data/us-zips) The uszips.csv file was parsed down to obtain the correlating zip codes that matched with the given latitude and longitude coordinates. The file can be accessed ![here](https://github.com/tutran90/Airbnb-A-Closer-Look-Nashville-Asheville/blob/main/simplemaps_uszips_basicv1.79/uszips.csv).
